        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectBugs_BugPriority_BugPriorityId",
                        column: x => x.BugPriorityId,
                        principalTable: "BugPriority",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectBugs_BugStatus_BugStatusId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserProjectMaps", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserProjectMaps_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserProjectMaps_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    ProjectBugId = table.Column<int>(type: "int", nullable: false),
                    ApplicationUserId = table.Column<string>(type: "varchar(95)", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectBugs_BugPriorityId",
                table: "ProjectBugs",
                column: "BugPriorityId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectBugs_BugStatusId",
                table: "ProjectBugs",
                column: "BugStatusId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserProjectMaps_ApplicationUserId",
                table: "UserProjectMaps",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserProjectMaps_ProjectId",
                table: "UserProjectMaps",
                column: "ProjectId");
        }
